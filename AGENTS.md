...
This repository is a modular frontend for dental lab and production operations. It is built as a route-registered admin application where features compose themselves into the app through shared infrastructure instead of wiring everything manually.
...
The order domain is large and already includes:
